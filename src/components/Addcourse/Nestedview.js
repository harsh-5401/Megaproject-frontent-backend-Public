...
function Nestedview({handleChangeEditSectionName}) {
  ...
  return (
    ...
    //                     </div>
    //                     <div className='flex items-center gap-x-3'>
    //                         {/* button for editting section  */}
    //                         <button onClick={()=>handleChangeEditSectionName(section._id , section.sectionname)} onChange={printsction(section)}>                            
    //                             <MdOutlineEdit></MdOutlineEdit>
    //                         </button>
    //                         {/* button for deleting entire section  */}
    //                         <button onClick={()=> { 
    //                             setconfirmationModal(
    //                                 {
    //                                     text1:"Delete this Section",
    //                                     text2:"All the sub Section in this section will be deleted",
    //                                     btn1text:"Delete",
    //                                     btn2text:"Cancel",
    ...
    //                 {/* render subsections inside sections  */}

    //                 <div>
    //                     {
    //                         section?.subsection?.map((data)=> {
    //                     return <div key={data?._id} onClick={()=> setviewsubsection(data)} className='flex items-center justify-between gap-x-3 border-b-2' >
    //                                 <div className='flex items-center gap-x-3'>
    //                                     <RxDropdownMenu></RxDropdownMenu>
    //                                     <p>{data.title}</p>
    //                                 </div>
    ...
    //                                         {/* button for editing subsection  */}
    //                                         <MdOutlineEdit></MdOutlineEdit>
    //                                     </button>
    //                                     {/* button for deleting subsection */}
    //                                     <button onClick={()=> {
    //                                         setconfirmationModal(
    //                                         {
    //                                             text1:"Delete this Sub Section",
    //                                             text2:"Selected lecture will be deleted will be deleted",
    //                                             btn1text:"Delete",
    //                                             btn2text:"Cancel",
    ...
    //    {
    //     confirmationModal ? (<ConfirmationModal modaldata={confirmationModal}></ConfirmationModal>) : (<div></div>)
    //    }
